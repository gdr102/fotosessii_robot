...
async def profile_kb(tg_id):
    """Клавиатура профиля: история, покупки, пополнение, приглашение, возврат в меню."""
    profile_kb = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=LEXICON_BUTTONS["btn_invite_friend"], callback_data=f"referral_{tg_id}")],
