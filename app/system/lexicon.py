from app.system.config import BOT_URL, CHANNEL_URL
...
LEXICON_MESSAGES = {
    ...
    # Подписка
    "sub_required": f"Для использования стилей необходимо подписаться на канал — @{CHANNEL_URL}",
    ...
    "creative_delay": "⏳ Процесс затянулся, подождите или попробуйте ещё раз.\nВ случае если результат не пришёл, а кредит автоматически не вернулся на баланс — напишите администратору.",
    ...
    # Реферальная система
    "ref_bonus_new_user": "🎁 Вам начислен 1 бонусный кредит по приглашению!",
